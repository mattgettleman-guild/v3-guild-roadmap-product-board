...
import { Home, Flag, LayoutGrid, Sparkles, Upload, Settings, ChevronLeft, ChevronRight, Download } from "lucide-react";
  ...
  return (
    ...
    >
      ...
      <nav className="flex-1 p-2 space-y-1">
        ...
        {/* Export — separate entry pointing to /import?section=export */}
        {(() => {
          const searchSection = (location.search as Record<string, unknown>)?.section;
          const isActive = location.pathname.startsWith("/import") && searchSection === "export";
          return (
            <Link
              to="/import"
